...
import co.com.crediya.dynamodb.adapters.DynamoDBTemplateAdapter;
...
class TemplateAdapterOperationsTest {
    ...
    void modelEntityPropertiesMustNotBeNull() {
        ApprovedReportEntity modelEntityUnderTest = new ApprovedReportEntity("id", "atr1");
    ...
    void testSave() {
        ...
        when(mapper.map(modelEntity, ApprovedReportEntity.class)).thenReturn(modelEntity);
